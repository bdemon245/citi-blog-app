    ...
    <div class="container px-sm-10">
        <div class="grid columns-2 gap-4">
            ...
            <div class="g-col-2 g-col-xl-1 d-none d-xl-flex flex-column min-vh-screen">
                <a style="color: white;text-decoration:none" href="login-light-login.html"
            ...
            <div class="g-col-2 g-col-xl-1 h-screen h-xl-auto d-flex py-5 py-xl-0 my-10 my-xl-0">
                <div
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="d-flex gap-5 align-items-center mt-5">
                            <a href="{{ route('login.social', 'google') }}" class="btn btn-light"><img class="me-3" width="20px"
                                src="https://img.freepik.com/free-icon/google_318-278809.jpg" alt="">Google</a>
                            <a href="{{ route('login.social', 'facebook') }}" class="btn btn-light"><img class="me-3" width="30px"
